---
layout: post
title:  "God’s Kingdom Designed Before Creation"
...
<br>—[Prop. 2, Obs. 1](/theocratic-kingdom-full/#obs-1-prop-2)
{% endcapture %}
...
One of the most vital distinctions in *The Theocratic Kingdom* is the location of this Kingdom. It is not merely a spiritual abstraction, but a <span class="kingdom-gold">physical reality tied to this planet</span>. Indeed, “The exercise of creative power, and its continued exhibition in behalf of man and the world, clearly shows the Divine determination to establish this kingdom.”
...
<br>—[Prop. 2, Obs. 2](/theocratic-kingdom-full/#obs-2-prop-2)
{% endcapture %}
{% include peters-quote.html content=pq %}
...
<br>—[Prop. 2, Obs. 3](/theocratic-kingdom-full/#obs-3-prop-2)
{% endcapture %}
{% include peters-quote.html content=pq %}
...
<br>—[Prop. 2, Obs. 4](/theocratic-kingdom-full/#obs-4-prop-2)
{% endcapture %}
{% include peters-quote.html content=pq %}
...
<br>—[Prop. 2, Obs. 5](/theocratic-kingdom-full/#obs-5-prop-2)
{% endcapture %}
{% include peters-quote.html content=pq %}
...
<br>—[Prop. 2, Obs. 6](/theocratic-kingdom-full/#obs-6-prop-2)
{% endcapture %}
{% include peters-quote.html content=pq %}
...
<br>—[Prop. 2, Obs. 7](/theocratic-kingdom-full/#obs-7-prop-2)
{% endcapture %}
{% include peters-quote.html content=pq %}
...
<br>—[Prop. 2, Obs. 9](/theocratic-kingdom-full/#obs-9-prop-2)
{% endcapture %}
{% include peters-quote.html content=pq %}

...
<br>— [Prop. 1, Intro](/theocratic-kingdom-full/#prop-1)
{% endcapture %}
...
The relationship between the King and the Kingdom is therefore inseparable. <span class="kingdom-gold">Christ is not absorbed into the doctrine of the Kingdom—He is the very center of it.</span> The covenants themselves point directly to Him as the heir of David’s throne (2 Sam 7:12–16; Lk 1:32–33). The Kingdom is not a competing theme alongside Christ; it is the arena in which His redemptive work reaches its full and visible expression.
...
<br>— [Prop. 1, Obs. 3](/theocratic-kingdom-full/#obs-3-prop-1)
{% endcapture %}
{% include peters-quote.html content=pq %}
...
<br>— [Prop. 1, Obs. 2](/theocratic-kingdom-full/#obs-2-prop-1)
{% endcapture %}
{% include peters-quote.html content=pq %}
...
<br>— [Prop. 1, Obs. 8](/theocratic-kingdom-full/#obs-8-prop-1)
{% endcapture %}
{% include peters-quote.html content=pq %}
